...
if __name__ == "__main__":
    ...
    # D:\DATA\CUHKSZ\2024-2025\ECE4513\final-project\cinematic-blur\data\DAVIS\JPEGImages\JPEGImages\480p\bear\00000.jpg

    base_dir = os.path.dirname(os.path.abspath(__file__))  # directory where script is
    video_path = os.path.abspath(os.path.join(base_dir, "../../data/DAVIS/videos/bear.mp4"))
    template_path = os.path.abspath(os.path.join(base_dir, "../../outputs/segmented/bear_segmented.png"))
    frame1_path = os.path.abspath(os.path.join(base_dir, "../../data/DAVIS/JPEGImages/JPEGImages/480p/bear/00000.jpg"))
    mask_output_path = os.path.abspath(os.path.join(base_dir, "../../outputs/DAVIS/segmented/bear"))
    blur_output_path = os.path.abspath(os.path.join(base_dir, "../../outputs/DAVIS/blurred/blurred_bear.mp4"))
