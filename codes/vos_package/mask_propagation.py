...
if __name__ == "__main__":
    ...
    template_path = os.path.abspath(os.path.join(base_dir, "../../outputs/segmented/clay_segmented.png"))
    frame1_path = os.path.abspath(os.path.join(base_dir, "../../data/personal/images/clay.png"))
    output_path = os.path.abspath(os.path.join(base_dir, "../../outputs/blurred/yey.mp4"))
